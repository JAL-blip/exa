...
def user_input_features():
  # Entrada
  Horas_estudiadas = st.number_input('hours_studied:', min_value=0, max_value=100, value = 0)
  Horas_dormidas = st.number_input('sleep_hours:',  min_value=0, max_value=12, value = 0)
  Asistencia = st.number_input('attendance_percent:', min_value=0, max_value=100, value = 0)
  Previo = st.number_input('previous_scores:', min_value=0, max_value=100, value = 0)
