...
def user_input_features():
  ...
  Horas_dormidas = st.number_input('sleep_hours:',  min_value=0, max_value=12, value = 0, step = 1)
  Asistencia = st.number_input('attendance_percent:', min_value=0, max_value=100, value = 0, step = 1)
  Previo = st.number_input('previous_scores:', min_value=0, max_value=100, value = 0, step = 1)
